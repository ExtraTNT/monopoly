...
public class UI extends Application {
    ...
    public void start(Stage primaryStage){
        ...
        Game.getInstance().addListener(new GameListener() {
            @Override
            public void onStart() {primaryStage.setScene(mainScene);}
            @Override
            ...
            @Override
            public void onStartDealing(Player currentPlayer) {primaryStage.setScene(dealScene); }
            @Override
            public void onWin(Player winer) { primaryStage.setScene(winScene); }
            @Override
            public void onBuy(Player player) {}
            @Override
            public void onHotel() { primaryStage.setScene(hotelScene); }
            @Override
